...
As we've seen, the `setCounter` updating function can take in a new state value, _or_ a function that accepts a previous state value and returns a new state value!
