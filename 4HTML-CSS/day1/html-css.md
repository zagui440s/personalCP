...
8. Change the `background-color` to something more desirable to your eyes.

### **Debugging CSS**

## Resources

- [Front End Intro](https://github.com/Code-Platoon-Curriculum/html-front-end-intro)

## Assignments

- [Top Ten](https://github.com/Code-Platoon-Assignments/html-top-ten)
